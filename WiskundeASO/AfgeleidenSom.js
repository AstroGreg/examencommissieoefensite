...
function Afgeleiden() {
// ---------------------------------------------------------------------------- create random numbers that cant be zero
  for(var i = 0 ; i === 0;){
...
// ---------------------------------------------------------------------------- randomly decicide if its going to be a som or a difference.   
